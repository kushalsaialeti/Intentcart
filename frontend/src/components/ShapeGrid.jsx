...
const ShapeGrid = ({
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      gradient.addColorStop(0.7, 'rgba(10, 10, 14, 0.4)');
      gradient.addColorStop(1, 'rgba(10, 10, 14, 0.85)');
    ...
    const updateAnimation = () => {
      // Very slow unnoticeable movement
      const effectiveSpeed = Math.max(speed, 0.04);
